...
#import "A3DetailViewController.h"

@interface A3MasterViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation A3MasterViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (!self.detailViewController) {
        self.detailViewController = [[[A3DetailViewController alloc] initWithNibName:@"A3DetailViewController" bundle:nil] autorelease];
    }
